...
<footer class="c-footer">
  <div class="o-center u-pt-2xl u-pb-2xl u-bg-qua">
    <div class="o-stack o-stack--s">
      <a href="<?php echo home_url('/');?>"
        class="o-icon-parent o-icon-parent--center o-icon-parent--text-center o-icon-parent--footer-logo">
        ...
        <span class="c-logo-label c-logo-label--footer u-font-logo u-flex-shrink-none u-first-color">BLUE B NOSE</span>
      </a>
      <span class="c-content-l u-text-secondary u-text-center">〒<span
          class="u-font-en-con"><?php echo get_vars('company', 'zip');?></span>
        <?php echo get_vars('company', 'address');?></span>
      <div class="o-cluster o-cluster--center u-mb-m">
      ...
      <span
        class="c-suppl-l u-text-center">営業時間&nbsp;<?php echo get_vars('company', 'workday');?>
        <span
          class="u-font-en-con"><?php echo get_vars('company', 'open');?>~<?php echo get_vars('company', 'close');?></span></span>
    </div>
  </div>
  <div class="o-center u-bg-secondary">
    <ul class="o-cluster u-max-item u-block-center">
      <li class="c-ft-item u-text-center"><a class="c-text-link c-text-link--footer c-content-m"
  ...
  <p class="o-center u-bg-primary c-suppl-m u-font-en-con u-text-center u-pt-m u-pb-m">
