...
<body <?php body_class();?>>
  ...
  <header class="u-pos-r">
    <div class="o-center c-header u-bg-qua">
      <a href="<?php echo home_url('/');?>"
        class="o-icon-parent o-icon-parent--center o-icon-parent--header-logo">
        <svg class="o-icon" width="670" height="403" viewBox="0 0 670 403" fill="none"
        ...
        <span class="c-logo-label c-logo-label--header u-font-logo u-flex-shrink-none u-first-color">BLUE B NOSE</span>
      </a>
    ...
    <nav id="gnav" class="c-gnav" aria-hidden="false" tabindex="">
      <ul class="o-switcher o-switcher--gap-none">
        <li class="c-gnav-item"><a <?php if(is_front_page()) {
            echo 'class="c-gnav-link c-gnav-link--is-current c-content-l u-text-weight-b u-pt-m u-pb-m"';
        } else {
            echo 'class="c-gnav-link c-content-l u-text-weight-b u-pt-m u-pb-m"';
        }?>
            href="<?php echo home_url('/');?>">トップ</a>
        </li>
        <li class="c-gnav-item"><a <?php if(is_page('company')) {
            echo 'class="c-gnav-link c-gnav-link--is-current c-content-l u-text-weight-b u-pt-m u-pb-m"';
        } else {
            echo 'class="c-gnav-link c-content-l u-text-weight-b u-pt-m u-pb-m"';
        }?> class="c-gnav-link c-content-l u-text-weight-b u-pt-m u-pb-m"
            href="<?php echo home_url('/company/');?>">会社情報</a>
        </li>
        <li class="c-gnav-item"><a <?php if(is_archive() && !is_post_type_archive('news') || is_single() && 'news' != get_post_type()) {
            echo 'class="c-gnav-link c-gnav-link--is-current c-content-l u-text-weight-b u-pt-m u-pb-m"';
        } else {
            echo 'class="c-gnav-link c-content-l u-text-weight-b u-pt-m u-pb-m"';
        }?> class="c-gnav-link c-content-l u-text-weight-b u-pt-m u-pb-m"
        ...
        <li class="c-gnav-item"><a <?php if(is_post_type_archive('news') || is_single() && 'news' == get_post_type()) {
            echo 'class="c-gnav-link c-gnav-link--is-current c-content-l u-text-weight-b u-pt-m u-pb-m"';
        } else {
            echo 'class="c-gnav-link c-content-l u-text-weight-b u-pt-m u-pb-m"';
        }?> class="c-gnav-link c-content-l u-text-weight-b u-pt-m u-pb-m"
        ...
        <li class="c-gnav-item"><a <?php if(is_page('inquiry')) {
            echo 'class="c-gnav-link c-gnav-link--is-current c-content-l u-text-weight-b u-pt-m u-pb-m"';
        } else {
            echo 'class="c-gnav-link c-content-l u-text-weight-b u-pt-m u-pb-m"';
        }?> class="c-gnav-link c-content-l u-text-weight-b u-pt-m u-pb-m"
